...
from app.agents.tools import get_order_details, search_products, visual_search_products, handle_conversation
...
def create_orchestrator_agent():
    ...
    agent = create_agent(
        model=llm,
        tools=[handle_conversation,search_products, visual_search_products, get_order_details],
        system_prompt=(
